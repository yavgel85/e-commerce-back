...
class CartTest extends TestCase
{
    ...
    public function test_it_gets_the_correct_subtotal(): void
    {
        $cart = new Cart(
            $user = User::factory()->create()
        );
    ...
    public function test_it_can_return_the_correct_total_without_shipping(): void
    {
        $cart = new Cart(
            $user = User::factory()->create()
        );
    ...
    public function test_it_can_return_the_correct_total_with_shipping(): void
    {
        $cart = new Cart(
            $user = User::factory()->create()
        );
